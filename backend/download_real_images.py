"""
Download Real Artwork Images Script
Downloads real images with proper headers
"""
...
def main():
    """Download all real artwork images"""
    # Manuel resimler klasörünü oluştur
    Path("manual_images").mkdir(exist_ok=True)
    
    # Gerçek resim URL'leri (alternatif kaynaklar)
    images = {
    ...
    print("🎨 Gerçek sanat eseri resimleri indiriliyor...")
    print("📡 Wikimedia'dan indiriliyor (User-Agent ile)...")
    ...
    if success_count > 0:
        ...
        print("\n❌ Hiç resim indirilemedi. Alternatif yöntem deneniyor...")
